...
#region Methods
        ...
        private void DrawAnimalListheader( ref Vector2 pos, Vector2 size, PawnKindDef pawnKind )
        {
            ...
            Rect ageRectC = new Rect( 0f, 0f, SmallIconSize, SmallIconSize ).CenteredIn( ageRect, SmallIconSize / 2 );
            Rect ageRectB = new Rect( 0f, 0f, SmallIconSize, SmallIconSize ).CenteredIn( ageRect );
            Rect ageRectA = new Rect( 0f, 0f, SmallIconSize, SmallIconSize ).CenteredIn( ageRect, -SmallIconSize / 2 );
        ...
        private void DrawAnimalRow( ref Vector2 pos, Vector2 size, Pawn p )
        {
            ...
            // lifestage column
            var ageRect = new Rect( pos.x, pos.y, colwidth, size.y );
            Rect ageIconRect = new Rect( 0f, 0f, SmallIconSize, SmallIconSize ).CenteredIn( ageRect );
            ...
            Label( meatRect, p.EstimatedMeatCount().ToString(), "FML.Yields".Translate( p.RaceProps.meatDef.LabelCap, p.EstimatedMeatCount() ),
