...
namespace FluffyManager
{
    public static class Widgets_Labels
    {
        public static void Label( Rect rect, string label, TextAnchor anchor = TextAnchor.UpperLeft, 
            GameFont font = GameFont.Small, Color? color = null, float margin = 0f, bool wrap = true )
        {
            rect.xMin += margin;
        ...
        public static void Label( ref Vector2 position, float width, float height, string label, TextAnchor anchor = TextAnchor.UpperLeft,
            GameFont font = GameFont.Small, Color? color = null, float margin = 0f, bool wrap = true )
        {
